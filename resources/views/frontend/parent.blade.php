                ...
                <div class="row g-5">
                    <div class="col-lg-4">
                        <div class="post-entry-1 lg">
                            <a href="single-post.html"><img src="zen/assets/img/post-landscape-1.jpg" alt=""
                                    class="img-fluid"></a>
                            ...
                            <div class="d-flex align-items-center author">
                                <div class="photo"><img src="zen/assets/img/person-1.jpg" alt=""
                                        class="img-fluid"></div>
                                <div class="name">
                        ...
                        <div class="row g-5">
                            <div class="col-lg-4 border-start custom-border">
                                <div class="post-entry-1">
                                    <a href="single-post.html"><img src="zen/assets/img/post-landscape-2.jpg"
                                ...
                                <div class="post-entry-1">
                                    <a href="single-post.html"><img src="zen/assets/img/post-landscape-5.jpg"
                                            alt="" class="img-fluid"></a>
                                ...
                                <div class="post-entry-1">
                                    <a href="single-post.html"><img src="zen/assets/img/post-landscape-7.jpg"
                                            alt="" class="img-fluid"></a>
                            ...
                            <div class="col-lg-4 border-start custom-border">
                                <div class="post-entry-1">
                                    <a href="single-post.html"><img src="zen/assets/img/post-landscape-3.jpg"
                                            alt="" class="img-fluid"></a>
                                ...
                                <div class="post-entry-1">
                                    <a href="single-post.html"><img src="zen/assets/img/post-landscape-6.jpg"
                                            alt="" class="img-fluid"></a>
                                ...
                                <div class="post-entry-1">
                                    <a href="single-post.html"><img src="zen/assets/img/post-landscape-8.jpg"
                                            alt="" class="img-fluid"></a>
