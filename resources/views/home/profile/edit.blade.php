    ...
    <div class="row">
        <div class="card p-4">
            ...
            <h3 class="card-title text-center fs-3">
                Update Profile <span class="fs-1 fw-bold text-decoration-underline text-warning">{{ Auth::user()->name }}</span>
            </h3>
            ...
            <form class="row g-3" method="post" action="{{ route('updateProfile') }}" enctype="multipart/form-data">
                ...
                <div class="col-12">
                    ...
                    <input type="text" class="form-control" id="Name" name="first_name" value="{{ $user->profile->first_name }}">
                </div>
                <div class="col-12">
